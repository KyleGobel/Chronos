...
namespace Chronos
{
    public enum UsTimeZone
    {
        ...
        Chicago = 2,
        PacificStandardTime = 3,
        LosAngeles = 3,
        MountainStandardTime = 4,
        Denver = 4,
    }
    ...
    public static class DateTimeExtensions
    {
        ...
        public static TimeZoneInfo GetTimeZoneInfo(this UsTimeZone tz)
        {
            switch (tz)
            {
                case UsTimeZone.CentralStandardTime:
                    return TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time");
                case UsTimeZone.EasternStandardTime:
                    return TimeZoneInfo.FindSystemTimeZoneById("Eastern Standard Time");
                case UsTimeZone.PacificStandardTime:
                    return TimeZoneInfo.FindSystemTimeZoneById("Pacific Standard Time");
                case UsTimeZone.MountainStandardTime:
                    return TimeZoneInfo.FindSystemTimeZoneById("Mountain Standard Time");
            }
            throw new ArgumentException("Unknown TimeZone", "tz");
        }
        public static TimeSpan GetUtcOffset(this DateTime date, UsTimeZone tz)
        {
            return tz.GetTimeZoneInfo().GetUtcOffset(date);
        }
        public static TimeSpan GetUtcOffset(this DateTime date, string olsonTimeZoneId)
        {
            return OlsonTimeZoneToTimeZoneInfo(olsonTimeZoneId).GetUtcOffset(date);
        }
